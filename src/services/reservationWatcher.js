...
export const STORAGE_LAST_RESERVATION_ID_KEY = '@mystoneinn_last_reservation_id';
export const STORAGE_CALENDAR_FP_KEY = '@mystoneinn_calendar_fingerprint';
export const STORAGE_CALENDAR_START_KEY = '@mystoneinn_calendar_start_date';
